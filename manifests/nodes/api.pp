...
node /[0-9]{1,12}.(default|manager|worker).gateway/ inherits base {
  ...
  class {'apimanager':
        ...
        amtype             => 'gateway',
        offset             => 0,
        config_database          => 'aesp_gateway_config',
        config_target_path => 'gateway_config',
	config_user          => 'aesp_gateway',
...
node /[0-9]{1,12}.(default|manager|worker).keymanager/ inherits base {
  ...
  class {'apimanager':
	...
	config_user          => 'aesp_store_pub',
  	config_password      => 'j2AxEle8',
        maintenance_mode   => 'refresh',
        depsync            => false,
...
node /[0-9]{1,12}.(default|manager|worker).apistore/ inherits base {
  ...
  class {'apimanager':
        ...
        amtype             => 'apistore',
        offset             => 0,
        config_database          => 'aesp_store_pub_config',
        config_target_path => 'store_pub_config',
	config_user          => 'aesp_store_pub',
	config_password      => 'j2AxEle8',
        maintenance_mode   => 'refresh',
        depsync            => false,
