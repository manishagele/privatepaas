...
define dynamic_lb::initialize ($repo, $version, $service, $local_dir, $target, $mode, $owner,) {
  ...
  file {
    "/${local_dir}/apache-stratos-${service}-${version}.zip":
      ...
      source => ["puppet:///modules/dynamic_lb/apache-stratos-${service}-${version}.zip", "puppet:///packs/apache-stratos-${service}-${version}.zip"],
